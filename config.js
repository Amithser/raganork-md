...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'ғʟᴀsʜ;ᴀᴍɪᴛʜ sᴇʀ;917561852787;https://i.imgur.com/st4R2dq.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || '𝛪𝑇𝑆 𝛭𝛯 𝐹𝐿𝛥𝑆𝛨',
    ...
    SUDO: process.env.SUDO || '917561852787',
